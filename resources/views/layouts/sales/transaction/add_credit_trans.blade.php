        ...
        <div class="col-md-12" style="display:inline-flex">
                    ...
                    <div class="header-title">
                        ...
                        <h6 class="card-subtitle text-muted text-red">Perform New Credit Sales Transaction</h6><br><br>
                            <div >
                                ...
                                <form class="row " action="{{ url('sales/credit_transaction/'.$insertid) }}" method="POST">@csrf
                                    <div class="col-6 select2-input" style="display:inline-flex">
                                        ...
                                        <select class="form-control select2 col-9" name="productid" id="productid" style="z-index: 99;" required>
                        ...
                        <div class="table-responsive rounded mb-3">
                            <table id="transTable" class="table data-table mb-0 table-bordered table-striped table-hover table-condensed">
                                ...
                                @foreach($gettemptrans as $trans)
                                    ...
                                    @include("layouts.sales.transaction.modal.credit_qty_trans")
                                    <!-- Update Qty Transaction Detail -->



                                    <!-- Update Discount Transaction Detail -->
                                    @include("layouts.sales.transaction.modal.credit_discount_trans")
                                    <!-- Update Discount Transaction Detail -->
                                    ...
                                    @include("layouts.sales.transaction.modal.credit_delete_trans")
                                    <!-- Delete One Transaction Detail -->
            ...
            <div class="col-md-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="row row-cols-md-auto align-items-center"  action="{{ url('sales/complete_credit_transaction/'.$insertid) }}" method="post">@csrf
                            <input type="hidden" class="form-control" id="insertid" name="insertid" value="{{ $insertid }}"/>
                            <!-- @foreach($gettemptrans as $trans)
                                <input type="hidden" class="form-control" id="productid" name="productid[]" value="{{ $trans->product->id }}"/>
                            @endforeach -->
                            <div class="col-12">
...
<div class="modal fade show" id="cancelCreditTrans{{ $insertid }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="background: rgba(0, 0, 0, 0.6)">
    ...
    <div class="modal-content">
        ...
        <form action="{{ url('sales/cancel_credit_transaction/'.$insertid) }}" method="post">@csrf
