 ...
 <div class="modal fade" id="updateCreditQty{{ $trans->id }}" tabindex="-1" role="dialog" aria-labelledby="updateCreditQty" aria-hidden="true" style="background: rgba(0, 0, 0, 0.6)">
    ...
    <div class="modal-content">
        ...
        <form action="{{ url('sales/update_credit_qty_transaction/'.$insertid ) }}" method="post">@csrf
            <div class="modal-body m-3">
                ...
                <div class="col-12">
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                        <input type="text" class="form-control" id="qtypcs"  value="{{ $trans->product->product_name }}"  disabled style="font-size:15px;font-weight:bolder"/>
                    </div>
                </div>
