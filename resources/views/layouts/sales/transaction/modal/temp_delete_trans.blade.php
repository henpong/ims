...
<div class="modal fade" id="deleteTempTrans{{ $trans->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteTrans" aria-hidden="true" style="background: rgba(0, 0, 0, 0.6)">
    <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        <div class="modal-header">
        <h5 class="modal-title" id="deleteTempTrans"><i class="fas fa-trash text-red"></i> Delete Record ?</h5>
        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true" style="color: #ff0000;">×</span>
        </button>
        </div>

        <form action="{{ url('sales/delete_temp_transaction/'.$insertid) }}" method="post">@csrf 
