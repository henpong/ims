...
<div class="row">
    <div class="col-12">
      ...
      <div id="invoice-POS">
        ...
        <div  id="mid">
          <div class="info">
            <div class="copy">CUSTOMER'S COPY</div>
        ...
        <div id="bot">
          ...
          <table>
              ...
              <tr class="tabletitle">
                ...
                <td></td>
                <!-- <td></td> -->
                <td class="payment">@if(isset($invoicedetails->id)) {{ number_format($invoicedetails->amt_due,2) }} @endif</td>
              </tr>
              ...
              <tr class="tabletitle">
                ...
                <!-- <td></td>
                <td></td> -->
                <td class="subtotal" colspan="20px">Change Amt(GHS)</td>
                <td></td>
                <!-- <td></td> -->
                <td class="payment">@if(isset($invoicedetails->id)) {{ number_format($invoicedetails->amt_change,2) }} @endif</td>
              </tr>
...
@include("layouts.sales.receipt.modal.new_trans")
