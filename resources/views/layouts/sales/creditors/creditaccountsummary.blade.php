...
<div class="col-sm-6 ">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ url('/sales/creditors') }}"><i class="ri-users-line mr-1 float-left"></i>Creditors</a></li>
                                                 ...
                                                 <div class="modal fade" id="makePayment" tabindex="-1" role="dialog" aria-labelledby="makePayment" aria-hidden="true" style="background: rgba(0, 0, 0, 0.6)">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{ url('sales/credit_paid/'.$paid->customers->id ) }}" method="post">@csrf
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-12">
                            ...
                            @if($custbalance == 0)
                                <a href="{{ url('sales/credit_transaction/'.$custdetails->id) }}" class="btn btn-sm btn-primary btn-round ml-auto" style="font-size:12px">
