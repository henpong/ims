  ...
  <div class="col-sm-6 ">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ url('/sales/customers') }}"><i class="ri-users-line mr-1 float-left"></i>Customers</a></li>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($credit->credit_status == 'Approved')
                                                <a href="{{ url('sales/credit_account_summary/'.$credit->id) }}" title="Open Creditor's Book"> <i class="fas fa-share text-blue"></i> </a>
                                            @else
