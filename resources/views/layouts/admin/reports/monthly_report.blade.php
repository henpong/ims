  ...
  <div class="col-sm-12">
    <div class="card">
            ...
            <div >
                ...
                <form class="row " action="{{ url('admin/monthly_transaction') }}" method="POST">@csrf
                    ...
                    <div class="col-3 select2-input" style="display:inline-flex;margin-left:0px">
                            ...
                            <div class="form-group mb-4" style="width:100%">
                                <div class="input-group input-daterange">
                                    <input type="text" class="form-control" id="monthTransactionDate" name="monthTransactionDate" placeholder="Choose a starting date" autocomplete="off" required>
