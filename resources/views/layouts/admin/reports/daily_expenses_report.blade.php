    ...
    <div class="card">
            ...
            <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                    <h4 class="card-title mb-3"><i class="nav-icon far fa-circle text-blue"> </i> Details of Previous Expenses</h4>
                </div>
            ...
            <div >
                ...
                <form class="row " action="{{ url('admin/previous_expenses') }}" method="POST">@csrf
                    ...
                    <div class="col-4"  style="margin-left:100px;">
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker select2" data-style="py-0" name="branchid" id="branchid" style="width:70%" require>
                    ...
                    <div class="col-3 select2-input" style="display:inline-flex;margin-left:0px">
                            <label class="" for="expensesDate" style="padding-top:10px;font-weight:bolder;padding-left:0px;"> Date</label>
                            <!-- Date Picker Input -->
                            <div class="form-group mb-4" style="width:100%">
                                <div class="input-group p-0 shadow-sm" >
                                    <input type="text" placeholder="Choose a date" class="form-control" data-date-end-date="0d" id="transactionDate" name="expensesDate" autocomplete="off" require>
