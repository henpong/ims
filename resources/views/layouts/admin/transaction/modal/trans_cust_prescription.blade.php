...
<div class="modal fade" id="detailedCustomerTrans" tabindex="-1" role="dialog" aria-labelledby="detailedCustomerTrans" aria-hidden="true" style="background: rgba(0, 0, 0, 0.6)">
    <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        <div class="modal-header">
        <h5 class="modal-title" id="detailedCustomerTrans"><i class="fas fa-users text-blue"></i> Customer Transaction</h5>
