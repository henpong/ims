 ...
 <div class="modal fade" id="updateCreditQty{{ $trans->id }}" tabindex="-1" role="dialog" aria-labelledby="updateCreditQty" aria-hidden="true" style="background: rgba(0, 0, 0, 0.6)">
    <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        <div class="modal-header">
        <h5 class="modal-title" id="updateCreditQty"><i class="far fa-edit text-blue"></i> Update Transaction Details</h5>
        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true" style="color: #ff0000;">×</span>
        </button>
        </div>

        <form action="{{ url('admin/update_credit_qty_transaction/'.$insertid ) }}" method="post">@csrf
            <div class="modal-body m-3">
                ...
                <div class="col-12">
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                        <input type="text" class="form-control" id="qtypcs"  value="{{ $trans->mainwarehouse->main_product_name }}"  disabled style="font-size:15px;font-weight:bolder"/>
                    </div>
                </div>
