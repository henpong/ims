...
<div class="modal fade" id="updateDiscount{{ $trans->id }}" tabindex="-1" role="dialog" aria-labelledby="updateDiscount" aria-hidden="true" style="background: rgba(0, 0, 0, 0.6)">
    <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        <div class="modal-header">
        <h5 class="modal-title" id="updateDiscount"><i class="far fa-edit text-blue"></i> Give Discount Amount (GHC)</h5>
        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true" style="color: #ff0000;">×</span>
        </button>
        </div>

        <form action="{{ url('sales/update_discount_transaction/'.$insertid ) }}" method="post">@csrf
