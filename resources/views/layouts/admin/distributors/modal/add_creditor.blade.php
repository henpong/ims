    ...
    <!-- Add Creditor -->
    <div class="modal fade" id="addBigCustomers" tabindex="-1" role="dialog" aria-labelledby="addBigCustomers" aria-hidden="true" style="background: rgba(0, 0, 0, 0.6)">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addBigCustomers"><i class="fas fa-pen text-blue"></i> Add New Customer</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true" style="color: #ff0000;">×</span>
                    </button>
                </div>

                <form action="{{ url('admin/addbigcustomer/' ) }}" method="post">@csrf
                    ...
                    <div class="modal-body m-3" style="max-height:450px; overflow:auto;">
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                <input type="text" class="form-control" id="fname" name="fname" placeholder="Enter Big Customer's Full Name" autocomplete="off"/>
                            </div>
                        </div>
