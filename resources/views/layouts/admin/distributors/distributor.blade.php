...
@section('content')
  ...
  <div class="col-sm-6 ">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Big Customers</li>
        </ol>
      </nav>
  </div>
  <br><br><br><br>
  <div class="col-sm-12">
    <div class="card">
            ...
            <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                    <h4 class="card-title mb-3"><i class="nav-icon fas fa-users text-blue"> </i> Big Customers</h4>
                </div>
                
                <button class="btn btn-sm btn-primary btn-round ml-auto" data-toggle="modal" data-target="#addBigCustomers" data-backdrop="static">
            ...
            <div class="card-body">
             ...
             <p class="mb-0">This is where you check all Big Customers you have served.</p><br><br>
    ...
    @include('layouts.admin.distributors.modal.add_creditor')
